    ...
    <div class="general-info clearfix">
        ...
        <div class="info-block">
            ...
            <table>
                ...
                <?php if(strlen($result['highway_name']) > 0){ $color_trigger=FALSE; ?>
                <tr <?php if($color_trigger) echo 'class="colored" ';?>>
                    <td class="cat-name">Шоссе:</td>
                    <td class="description"><?=$result['highway_name'];?></td>
                </tr>
                <?php $color_trigger=TRUE;}?>

                <?php if (strlen($result['28'])>0) {  ?>
                <tr <?php if($color_trigger) echo 'class="colored" ';?>>
                ...
                <tr <?php if(!$color_trigger) echo 'class="colored" ';?>>
                    <td class="cat-name">Площадь помещ-й:</td>
                    <td class="description"><?=(int)$result['9'];?> кв.м.</td>
                </tr>

                <?php if (strlen($result['10'])>0) { ?>
                <tr <?php if($color_trigger) echo 'class="colored" ';?>>
